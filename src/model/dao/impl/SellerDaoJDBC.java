...
public class SellerDaoJDBC implements SellerDao{
	...
	public List<Seller> findByDepartment(Department department) {
		...
		try {
			...
			Map<Integer, Department> map = new HashMap<>(); /* Map é utilizado para verificar se o departamento já foi instanciado.
															*  Isso garante que não criem-se 2 instancias de dep. c/ mesmo id
															*/
			// Cria as instâncias do objeto a partir da consulta no banco de dados
